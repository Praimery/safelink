var navigation = document.querySelectorAll("head meta"); - 1 == (navigation = (navigation = navigation[navigation.length - 1]).nextElementSibling.innerHTML).indexOf("http://www.idblanter.com") && (window.location.href = "http://www.idblanter.com");
