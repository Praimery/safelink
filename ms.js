var navigation = document.querySelectorAll("head meta"); - 1 == (navigation = (navigation = navigation[navigation.length - 1]).nextElementSibling.innerHTML).indexOf("https://mdsafelink.blogspot.com") && (window.location.href = "https://mdsafelink.blogspot.com");
...
input.onkeyup = md, password.onkeyup = md;
...
$(document).ready(function() {
    $(".btn-safe").click(function() {
        input.value.length && $("#mdsafelink,.matilampu").toggleClass("aktif")
    })
});
